...
// Compatibilité entre le profil de risque (issu du diagnostic 14 questions) et la stratégie
// choisie par le client dans son plan — pas une correspondance de noms, une vraie logique par
// niveau de risque. Un profil peut être à l'aise avec plusieurs stratégies ; l'important est
// de repérer un vrai décalage (ex: profil Prudent qui choisit Croissance).
const PROFILS_COMPATIBLES = {
  prudente: ['Prudent', 'Équilibré'],
  rendement: ['Prudent', 'Équilibré'],
  equilibree: ['Équilibré', 'Dynamique'],
  croissance: ['Dynamique', 'Offensif']
};

module.exports = { STRATEGIES, PROFILS_COMPATIBLES };
